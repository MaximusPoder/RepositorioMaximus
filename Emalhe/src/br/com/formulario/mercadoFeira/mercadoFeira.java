 ...
 * @author Jhonathas
 */
public class mercadoFeira extends javax.swing.JFrame {
    ...
    public mercadoFeira() {
        ...
        try {
            ...
            Logger.getLogger(mercadoFeira.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        chbMercado = new javax.swing.JRadioButton();
        chbFeira = new javax.swing.JRadioButton();
        cbAtividadePrincipal = new javax.swing.JComboBox();
        jLabel1 = new javax.swing.JLabel();
        tfNumeroBoxes = new JIntField();
        tfQuantosPossui = new JIntField();
        ...
        jLabel42.setText("Questionário Mercado / Feira");
        ...
        definicao.add(chbMercado);
        chbMercado.setText("Mercado");

        definicao.add(chbFeira);
        chbFeira.setText("Feira Livre");

        cbAtividadePrincipal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        jLabel1.setText("Nº Total de boxes no local.:");

        jLabel36.setText("Quanto Possui.:");
                    ...
                    .addGroup(jpAtravessadorLayout.createSequentialGroup()
                        ...
                        .addGroup(jpAtravessadorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jpAtravessadorLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(chbMercado)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(chbFeira))
                            ...
                            .addGroup(jpAtravessadorLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jpAtravessadorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(cbEstadoCivil, 0, 215, Short.MAX_VALUE)
                                    .addComponent(tfNumeroBoxes, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 215, Short.MAX_VALUE)
                                    .addComponent(cbAtividadePrincipal, javax.swing.GroupLayout.Alignment.LEADING, 0, 215, Short.MAX_VALUE)
                                    .addComponent(cbEscolaridade, 0, 215, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jpAtravessadorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jpAtravessadorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(tfPqParou, javax.swing.GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE)
                                    .addComponent(tfComposicaoFamiliar, javax.swing.GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE)
                                    .addComponent(tfQuantosPossui, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE)
                                    .addComponent(tfAtividadeSecundaria, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE))))))
                .addContainerGap())
        );
            ...
            .addGroup(jpAtravessadorLayout.createSequentialGroup()
                ...
                .addGroup(jpAtravessadorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jpAtravessadorLayout.createSequentialGroup()
                        .addGroup(jpAtravessadorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel1)
                            .addComponent(tfNumeroBoxes, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void botao_alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_alterarActionPerformed
        try{
            String sql ="UPDATE mercado_feira SET "+
                    ...
                    "numero_boxes_local = '"+tfNumeroBoxes.getText() +"',"+
                    "quantos_boxes_possui = '"+tfQuantosPossui.getText() +"',"+
                    ...
                    "where cod_mercado_feira = "+conexao.resultSet.getString("cod_mercado_feira");
    ...
    private void botao_excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_excluirActionPerformed
        String sql;
        try {
            sql = "select * from mercado_feira Where cod_mercado_feira =" + conexao.resultSet.getString("cod_mercado_feira");
            conexao.execute(sql);
            conexao.resultSet.first();
            String nome = "Deletar o mercado/feira : "+conexao.resultSet.getString("nome")+" ?";
            int opcao_escolhida = JOptionPane.showConfirmDialog(null,nome,"Exclusão ",JOptionPane.YES_NO_OPTION);
            if (opcao_escolhida == JOptionPane.YES_OPTION) {
                sql = "DELETE FROM mercado_feira Where cod_mercado_feira ="+conexao.resultSet.getString("cod_mercado_feira");
    ...
    */
    ...
    private javax.swing.JRadioButton chbFeira;
    private javax.swing.JRadioButton chbMercado;
    ...
    private javax.swing.JTextField tfNumeroBoxes;
    ...
    private void mostra_dados(){
       String teste = new String();
        try {
            ...
            if (teste.equals(chbMercado.getText()))
                chbMercado.setSelected(true);
            else if (teste.equals(chbFeira.getText()))
                chbFeira.setSelected(true);
            ...
            tfNumeroBoxes.setText(conexao.resultSet.getString("numero_boxes_local"));
            tfQuantosPossui.setText(conexao.resultSet.getString("quantos_boxes_possui"));
    ...
    private void anterior() {
         try {
                    ...
                    Logger.getLogger(mercadoFeira.class.getName()).log(Level.SEVERE, null, ex1);
                }
    }
    ...
    private String getDefinicao() {
        ...
        if (chbMercado.isSelected())
            tdefinicao = chbMercado.getText();
        else if (chbFeira.isSelected())
            tdefinicao = chbFeira.getText();
    ...
    private void limpar() {
        ...
        cbEscolaridade.setSelectedIndex(0);
        chbMercado.setSelected(false);
        tfNumeroBoxes.setText("");
        tfQuantosPossui.setText("");
        chbFeira.setSelected(false);
    }
