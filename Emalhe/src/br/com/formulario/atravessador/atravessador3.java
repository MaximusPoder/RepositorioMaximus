...
public class atravessador3 extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel30, javax.swing.GroupLayout.DEFAULT_SIZE, 743, Short.MAX_VALUE)
            ...
            .addComponent(jSeparator1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 771, Short.MAX_VALUE)
        );
    ...
    */
    ...
    private void mostra_dados(){
        ...
        try {
            //Pescador Moradia
            conexao.execute("SELECT * FROM atravessador_perspectiva WHERE cod_atravessador = "+codigo);
    ...
    private void attCbAtravessador() {
        try {
            ...
            while (conexao.resultSet.next()){
                cbAtravessador.addItem(conexao.resultSet.getString("cod_atravessador")+
                            " # "+ conexao.resultSet.getString("nome"));
            }

        }catch (SQLException ex) {
            System.out.println("Erro no atravessador "+ex);
        }
    }
    ...
    System.out.println(codigo);
            ...
            String sqlinsert = "insert into atravessador_perspectiva "
                    + "(cod_atravessador,questao1,questao2,questao2_1,questao2_2,"
    ...
    System.out.println(codigo);
        ...
        String sqlupdate ="UPDATE atravessador_perspectiva SET "
