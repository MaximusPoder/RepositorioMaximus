...
import br.com.formulario.empresa.dao.DAOQuestionario7;
...
public class WinQuestionario7 extends javax.swing.JPanel {
    ...
    private EmpresaQuestionario7 eq;
    ...
    private EmpresaQuestionario7 getQuestionarioOfPanel() {
        ...
        try {
            ...
            if (eq != null) {
                ...
                eq.all(questao55, questao56, questao57,
    ...
    private void setQuestionarioForPanel(EmpresaQuestionario7 eq) {
    ...
    private void action(ActionEvent e) {
        ...
        if (cmd.equalsIgnoreCase("Salvar")) {
            if (eq == null) {
                ...
                new DAOQuestionario7().cadastrar(eq);
            } else {
                 eq = getQuestionarioOfPanel();
            new DAOQuestionario7().atualizar(eq);
            }
                    ...
                    .addGroup(tabQuestionarioLayout.createSequentialGroup()
                        ...
                        .addGroup(tabQuestionarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(tabQuestionarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(jLabel39, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addComponent(jScrollPane3, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 364, javax.swing.GroupLayout.PREFERRED_SIZE)
