...
import br.com.formulario.empresa.dao.DAOQuestionario5;
...
public class WinQuestionario5 extends javax.swing.JPanel {
    ...
    private EmpresaQuestionario5 eq;
    ...
    private void initComponents() {
        ...
        tabQuestionarioLayout.setHorizontalGroup(
            ...
            .addGroup(tabQuestionarioLayout.createSequentialGroup()
                ...
                .addContainerGap())
            .addComponent(panelCrudEmpresa8, javax.swing.GroupLayout.DEFAULT_SIZE, 927, Short.MAX_VALUE)
            .addGroup(tabQuestionarioLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(tabQuestionarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void refresh() {
        if (WinSelecionaEmpresa.cbEmpresa.getSelectedIndex() > 0) {
            eq = new DAOQuestionario5().getObjectWithQuery("select * from EmpresaQuestionario5" +
                    " where empresaId = " +
    ...
    private void action(ActionEvent e) {
        ...
        if (cmd.equalsIgnoreCase("Salvar")) {
            if (eq == null) {
                ...
                new DAOQuestionario5().cadastrar(eq);
            } else {
                 eq = getQuestionarioOfPanel();
            new DAOQuestionario5().atualizar(eq);
