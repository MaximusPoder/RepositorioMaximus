...
package br.com.formulario.caminhoneiro;
...
public class caminhoneiro2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel41.setText("Question�rio Caminhoneiro");
        ...
        jLabel43.setText("Quando tempo est� na atividade?");

        jLabel44.setText("Qual?");

        jLabel45.setText("Desde quando?");

        jLabel47.setText("Tem registro em alguma entidade de classe (col�nia, associa��o, cooperativa)?");

        jLabel49.setFont(new java.awt.Font("Tahoma", 1, 11));
        jLabel49.setText("Quem de sua fam�lia trabalha? E com qual atividade?:");
        ...
        jLabel57.setText("Recebe algum benef�cio do governo.:");

        jLabel58.setFont(new java.awt.Font("Tahoma", 1, 12));
        jLabel58.setText("Como funciona o \"caminho da cadeia de comercializa��o\" do pescado ou da grude");

        jLabel59.setFont(new java.awt.Font("Tahoma", 1, 11));
        jLabel59.setText("1 - Recep��o dos produtos:");
        ...
        jLabel4.setText("Quantos fornecedores s�o?");

        jLabel5.setText("O n� de fornecedores aumntaram nos �ltimos 5 anos?");
        ...
        jLabel6.setText("O produto voc� adquire:");
        ...
        jLabel60.setText("2 - Aquisi��o (comercializa��o):");

        jLabel7.setText("S� vende o peixe inteiro?");

        ckbSoPeixeiInteiro.setText("Sim");

        jLabel9.setText("Quais outras formas de comercializa��o?");
        ...
        jTableFormaComercializacao.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod", "Esp�cie Produto", "Eviscerado", "Salgado", "Fil�", "Postas", "Sem cabe�a", "Outros"
            }
        ) {
        ...
        jLabel10.setText("Esp�cie Produto.:");
        ...
        jLabel17.setText("Esp�cie Produto.:");
        ...
        jtGrude.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod", "Esp�cies", "Volume (KG)", "Pre�o (R$)", "Tipo"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jLabel18.setText("A grude comercializada � de qual esp�cie? Por semana");

        jLabel19.setText("Tipo.:");

        jLabel21.setText("Pre�o R$.:");
        ...
        jLabel20.setText("Quais os crit�rios para definir a qualidade do produto?");
        ...
        ckbConsistenciaCarnePeixe.setText("Consist�ncia");
        ...
        jLabel62.setText("4 - Comercializa��o");

        jLabel28.setText("Qual o mercado que voc� comercializa?");

        cbMercado.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Mercado local no mesmo munic�pio", "Mercado Estadual", "Mercado Nacional", "Mercado Internacional" }));
        ...
        cliente_pescado_empresa_municipio.setText("1 Empresa de pesca do munic�pio");
        ...
        cliente_pescado_supermercado_municipio.setText("5 Supermercado do munic�pio");

        cliente_pescado_caminhao.setText("6 Caminh�o");

        cliente_pescado_outro_atravessador.setText("8 Outro Atravessdor");

        cliente_grude_atravessador_municipio.setText("1 Atravessador do munic�pio");

        cliente_grude_atravessador_outro_municipio.setText("2 Atravessador de outro munuc�pio");

        cliente_grude_empresa_belem.setText("3 Empresa de Bel�m");
        ...
        jtForma.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod", "Esp�cie", "Produto", "Cliente", "Destino", "Volume", "Pre�o"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        cbGastos.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Combust�vel", "Lubrificante", "Gelo", "Carregador do pescado", "Manuten��o do ve�culo", "Outro" }));
        ...
        jLabel69.setText("Quais os gastos voc� tem com cada barco por pescaria?");
        ...
        ckbSemCabecaAq.setText("Sem Cabe�a");
        ...
        ckbFrigorificoPescador.setText("Caminh�o frigor�fico");
        ...
        ckbNaoSabeFornecedores.setText("N�o sabe");
    ...
    private void cbNomeCaminhoneiroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbNomeCaminhoneiroActionPerformed
        ...
        //Pesquisa autom�tica do Combo Box Nome do caminhoneiro
    ...
    */
    ...
    private void mostra_dados(){
        ...
        try {
           ...
           if (conexao.resultSet.getString("empresa_fornece_pescado").equals("1"))
            ...
            System.out.println("2 Recep��o - Passou ");
            ...
            System.out.println("3 Aquisi��o - Passou");
            ...
            System.out.println("5 Com�rcio - Passou");
    ...
    private void addBtRt() {
        ...
        System.out.println(codigo);
          ...
          //Rela��es de Trabalho - Tabela Renda Familia
    ...
    System.out.println(codigo);
       ...
       //Recep��o caminhoneiro
            ...
            //System.out.println(sqlinsert);
            if (conexao.salvar(sqlinsert)) {
                System.out.println("2 Recep��o - Cadastrado com sucesso");
            }
            ...
            if (conexao.salvar(sqlinsert)) {
                ...
                System.out.println("5 Comercializa��o - Cadastrado com sucesso");
                mostra_dados();
            }
    ...
    //Pescador Moradia
            ...
            //System.out.println(sqlupdate);
            if (conexao.update(sqlupdate)){
                System.out.println("Recep��o - Atualizado com sucesso");
                //Atualiza Resultset
            }
            ...
            //System.out.println(sqlupdate);
            if (conexao.update(sqlupdate)){
                System.out.println("Aquisi��o - Atualizado com sucesso");
                //Atualiza Resultset
            }
            ...
            if (conexao.update(sqlupdate)){
                ...
                System.out.println("Com�rcio - Atualizado com sucesso");
                //Atualiza Resultset
                mostra_dados();
            }
    }
