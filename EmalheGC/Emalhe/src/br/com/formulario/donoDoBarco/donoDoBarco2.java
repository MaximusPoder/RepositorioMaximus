package br.com.formulario.donoDoBarco;
...
public class donoDoBarco2 extends javax.swing.JFrame {
    ...
    private int inicia_combo = 0; //Evita a ativa��o inicial do cbPescador
    ...
    public donoDoBarco2() {
        ...
        attCbdono_barco();
        //Insere nome da Esp�cie no cbEspecie
        attCbs();
        mudar_estadoCB();
    ...
    private void initComponents() {
        ...
        setTitle("Question�rio Dono do Barco");
        ...
        jLabel41.setText("Fossa seca ou s�pica.:");

        jPanel4.setBackground(new java.awt.Color(255, 255, 255));

        jLabel42.setFont(new java.awt.Font("Tahoma", 1, 12));
        jLabel42.setText("Question�rio Dono do Barco");
        ...
        jLabel47.setText("Desde quando � pescador.:");
        ...
        jLabel48.setText("Rela��es de Trabalho");
        ...
        ckbParceria.setText("Parceria, com vizinhos, amigos etc. (o lucro � dividido)");
        ...
        jLabel3.setText("Em alguma associa��o.:");

        jLabel2.setText("Na col�nia.:");
        ...
        jLabel7.setText("Recebe algum benef�cio do governo.:");
        ...
        jLabel49.setText("Composi��o da Pescaria");

        jLabel8.setText("Pescaria Principal (esp�cie).:");
        ...
        jLabel51.setText("Dados da Embarca��o");

        jLabel22.setText("A embarca��o foi financiada.:");

        jLabel23.setText("Tipo.:");

        jLabel25.setText("Qual.:");

        jLabel26.setText("Nome da embarca��o:");
        ...
        jLabel29.setText("Como se faz a conserva��o do pescado.:");

        inssinss.add(rbInssSim);
        rbInssSim.setText("Sim aut�nomo");

        inssinss.add(rbInssNao);
        rbInssNao.setText("Sim empregado");

        inssinss.add(rbInssEmpregado);
        rbInssEmpregado.setText("N�o");
        ...
        jLabel61.setText("mil�metros");

        ckbGelo.setText("Gelo");

        ckbSal.setText("Sal");

        ckbFrigorifico.setText("Frigor�fico");

        jLabel13.setText("Os petrechos s�o pr�prios?");
        ...
        jLabel15.setText("Se n�o, de quem s�o.:");

        jLabel16.setText("Onde adquire as panagens ou redes prontas:");

        jLabel17.setText("Local.:");

        jLabel18.setText("Por qu�.:");

        jLabel19.setText("Qual o custo do entalhamento.:");

        jLabel20.setText("Qual o custo com chumbos.:");

        jLabel21.setText("Qual o custo com b�ias.:");

        jLabel62.setText("Quantas viagens por m�s.:");

        jLabel63.setText("Produ��o por viagem.:");
        ...
        jLabel34.setText("Qual a renda m�dia por pescaria.:");
        ...
        cbGastosViagem.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Combust�vel", "Lubrificante", "Gelo", "Rancho", "Pagamento de pescador - Vale", "Frete", "Carregador do pescado", "Gelo para transporte", "Outro" }));
        ...
        cbGastosANO.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Manuten��o Da Rede", "Manuten��o Do Barco", "Outro" }));
        ...
        jLabel77.setText("Qual o destino da produ��o (pra onde voc� comercializa).");
        ...
        ckbDestinoCaminhao.setText("Caminh�o");
        ...
        jLabel55.setText("(De qual institui��o?)");
        ...
        cbMaterialCasco.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Madeira", "A�o", "Fibra", "Outro" }));

        jLabel80.setText("Propuls�o.:");
        ...
        jLabel85.setText("Ano de constru��o.:");
        ...
        jLabel86.setText("Situa��o.:");

        cbSitucao.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Excelente", "Bom", "Regular", "Ruim" }));

        jLabel28.setText("Possui inscri��o (IBAMA/CAPITANIA).:");

        ckbPossuiInscricaoSim.setText("Sim");

        jLabel87.setText("Existe algum grau de depend�ncia com um atravessador?");
        ...
        jtDadosEmbarcacao.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod", "Financiada", "Forma", "Nome", "Comprimento", "Ton Bruta", "Ton L�quida", "Material", "Propuls�o", "Cilindros", "Marca", "Tripula��o", "Ano", "Situa��o", "Inscri��o"
            }
        ) {
            boolean[] canEdit = new boolean [] {
    ...
    //Pescador Moradia
        ...
        //Rela��es de Trabalho
            ...
            if (conexao.salvar(sqlupdate)) {
                System.out.println("2 Rela��es de Trabalho - Atualizado com sucesso");
            }


        //Composi��o da Pescaria
            ...
            //System.out.println(sqlupdate);
            if (conexao.salvar(sqlupdate)) {
                System.out.println("3 Composi��o da Pescaria - Alterado com sucesso");
...
//            Rela��es de Trabalho
            ...
            System.out.println("Passou! Rela��es de Trabalho");
            ...
            System.out.println("Passou! Composi��o da Pescaria");
...
//
//            System.out.println("Passou! Dados Embarca��o");
    ...
    //Trabalho com a tabela Composi��o Pescaria
    private void addBtCP() {
    String codigo = util.separa(1,cbDonoBarco.getSelectedItem().toString());
    System.out.println(codigo);

          //Tabela Locais da composi��o pescaria
    ...
    System.out.println(codigo);
        ...
        String sqlinsert = "insert into dono_barco_dados_embarcacao "
            ...
            System.out.println(sqlinsert);
            if (conexao.salvar(sqlinsert)) {
               System.out.println("Dados Embarca��o");
               attjtDadosEmbarcacao();
            }
    }
