...
public class donoDoBarco3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel43.setText("Percep��o e Perspectivas:");

        taq7.setColumns(20);
        taq7.setRows(5);
        jScrollPane5.setViewportView(taq7);

        jLabel27.setText("2 - Quais os motivos voc� acredita serem respons�veis pela diminui��o?");

        jLabel28.setText("3 - Caso ocorra desaparecimento do pescado, como voc� sustentaria sua fam�lia?");
        ...
        jLabel35.setText("8 - Que perspectivas voc� tem (v�) para os pr�ximos anos?");

        ckb8DeCrescimento.setText("De crescimento");

        ckb8Estabilizacao.setText("Estabiliza��o");

        ckb8DeDiminuicao.setText("De diminui��o");
        ...
        jLabel36.setText("1 - Voc� tem percebido mudan�a no tamanho e na quantidade do pescado?");
        ...
        jLabel31.setText("5 - Quais as poss�veis solu��es (demandas) pra melhorar o seu trabalho?");

        taq6.setColumns(20);
        taq6.setRows(5);
        jScrollPane9.setViewportView(taq6);

        jLabel32.setText("6 - Existem conflitos com institui��es (IBAMA, MPA, SEPAQ)? Quais institui��es e descrever os conflitos.");
